...
CLabel& CLabel::SetWrap(bool flag)
...
CLabel& CLabel::SetSingle(bool flag)
...

{
	...
	int flag = 0; //DT_WORDBREAK;
	if(m_wrap)
		flag = SS_LEFTNOWORDWRAP;
...
{
	//AP2N("CLabel::PreSubclassWindow\r\n");
	//ModifyStyle(0, 0, SWP_NOSIZE | SWP_NOMOVE);
